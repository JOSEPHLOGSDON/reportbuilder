...
description: >
  ...
  as bloom / panel / tile underprint, Instrument Serif display + Inter sans + JetBrains Mono data,
...
- **Instrument Serif 400** display (tight, negative-tracked); **Instrument Serif** body + micro-labels; **JetBrains Mono** data.
...
Two ramps. The **reading/data ramp** (Instrument Serif body 0.85cqw ink, micro-labels in px, JetBrains Mono
...
- Set every line in **ink**; use **Instrument Serif 400** (tight, negative-tracked) for display, **Instrument Serif** body, **JetBrains Mono** for all numerals/dates.
...
- **Instrument Serif + Instrument Serif + JetBrains Mono via Google Fonts.** CJK: Smiley Sans (display) / Noto Serif SC (body) / Noto Sans SC (labels); italic serif and mono tabular figures have no exact Hanzi equal — keep ledger dates Latin.
